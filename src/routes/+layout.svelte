...
<div data-theme={$theme} class="app">
  ...
  <div id="main">
    <div id="menu">
      <button
        style={`left:${isOpenSide ? 224 : 60}px`}
    ...
    <div class="preloading">
      <div class="gyuys">
        <img
          class="coin-icon"
          alt=""
          src="https://res.cloudinary.com/dxwhz3r81/image/upload/v1699447809/preload_b2jdw0.jpg"
        />
      </div>
    </div>
  {/if}
  ...
  <div
    ...
    style={is_mobile
      ? ""
      : `width: ${
          isChatRoom ? ens - sideDetection - 360 : ens - sideDetection
        }px;`}
  >
    <header>
      <Navbar
        on:handleMenuMobile={handleMenu}
        on:handleChatRoom={handleChatroom}
        styles={isOpenSide}
        chatroom={isChatRoom}
      />
    </header>
