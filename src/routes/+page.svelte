...
<div id="main" class={isLightMode ? "light-grey-bg sc-lhMiDA ePAxUv" : "sc-lhMiDA ePAxUv"}>
  <div id="home" class="sc-jwQYvw eRdxAb">
    <div class="sc-bLdqUH bPsBUR banner">
      <div class="gradient-wrap">
        <div
          class="swiper swiper-initialized swiper-horizontal sc-haTkiu iyCsvj"
        >
          <swiper-container
            ...
            <swiper-slide class="swiper-slide swiper-slide-duplicate">
              <div class="sc-kTqLtj dnfJpJ">
                <a href="/" class="sc-cfJLRR joQyOD">
                  <img
                    src="https://img2.nanogames.io/banner/40/b2/cb/164300069674127.png"
                    alt=""
                  />
                </a>
                <a href="/" class="sc-cfJLRR ktmMpR">
                  <img
                    src="https://static.nanogames.io/assets/lottery.cb45faf6.png"
                    alt=""
                  />
                </a>
                <a href="/" class="sc-cfJLRR ktmMpR">
...
<div class="mobile">
  <div id="home" class="sc-gFSQbh iDnJIm">
    <div class="sc-jibziO bYDJIH banner gradient-mobile">
      <div class="gradient-wrap">
        <div
          class="swiper swiper-initialized swiper-horizontal swiper-ios sc-cfJLRR bOeOZi"
        >
          <swiper-container
            class="swiper-wrapper"
            slides-per-view={1}
          ...
          >
            <swiper-slide class="swiper-slide swiper-slide-duplicate">
              <div class="sc-haTkiu dxHxHL">
                <a href="/" class="sc-jCHUfY eGrXvR">
                  <img
                    src="	https://img2.nanogames.io/banner/af/c7/94/164300069949835.png"
                    alt=""
                  />
                </a>
              </div>
            ...
            <swiper-slide class="swiper-slide swiper-slide-duplicate">
              <div class="image-content">
                <a href="/" class="sc-jCHUfY eGrXvR">
                  <img
                    src="https://img2.nanogames.io/banner/cf/56/a5/164300091137615.png"
                    alt=""
                  />
                </a>
              </div>
            ...
            <swiper-slide class="swiper-slide swiper-slide-duplicate">
              <div class="image-content">
                <a href="/" class="sc-jCHUfY eGrXvR">
                  <img
                    src="https://img2.nanogames.io/banner/58/3b/b1/164300088905192.png"
                    alt=""
                  />
                </a>
              </div>
            ...
            <swiper-slide class="swiper-slide swiper-slide-duplicate">
              <div class="image-content">
                <a href="/" class="sc-jCHUfY eGrXvR">
                  <img
                    src="https://img2.nanogames.io/banner/b7/6d/13/164300094200682.png"
                    alt=""
                  />
                </a>
              </div>
    ...
    <div class="sc-gFSQbh blNkCs">
      <div class="sc-iRFsWr dGbYFZ" style="height: auto;">
        <div class="sc-aaqME jiYpQl">
          <div class="sc-ihINtW cvKYOe sc-eSxRXt fLGcZr mobile-top-swiper">
            <div class="sc-cxpSdN kQfmQV tabs">
              <div class="tabs-navs">
                <button class="tabs-nav is-active">
                  <div class="sc-cxVPaa jPPoTb">
                    <div class="top">
                      <div class="circle">
                        <img
                          alt="logo"
                          src="https://static.nanogames.io/assets/bigprofit.ae9b1ce1.png"
                        />
                      </div>
                      <div class="word">
                        <p>
                          <span style="color: rgb(231, 11, 108);">Much</span>Wow
                          Wins
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="sc-cxVPaa jPPoTb">
                    <div class="top">
                      <div class="circle">
                        <img
                          alt="logo"
                          src="https://static.nanogames.io/assets/topprofit.bc94f362.png"
                        />
                      </div>
                      <div class="word">
                        <p>
                          <span style="color: rgb(245, 192, 31);">Top</span
                          >Winning Games
                        </p>
                      </div>
                    </div>
                ...
                <div class="bg is-reverse" style="left: 0%; right: 50%;"></div>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div class="mobile-top-games-wrap">
                      <div class="item-wrap">
                        <div class="sc-bnOPBZ gZglJR win-game-item">
                          ...
                          <div class="right">
                            <div class="right-word-wrap">
                              <p class="sp">ENEMYDOWN</p>
                            </div>
                            <div class="right-word-wrap big-word">
                              <p title="Won: $1131.36">
                                Won:<span>$1131.36</span>
                              </p>
                            </div>
                            <div class="right-word-wrap"><p>In Crash</p></div>
                          </div>
                        </div>
                      </div>
                      <div class="item-wrap">
      ...
      <div class="sc-jYmNlR jjBLrt sc-emDsmM CqKVI">
        ...
        <div class="sc-bjeSbO gqCCHE grid-list">
          <div class="sc-gfqkcP epfPPG bot-view super-block game-crash">
            <a class="sc-hKTqa gJEGaM game-item-wrap" href="/crash">
              <div class="lazy-img img">
                <img
                  src="https://img2.nanogames.io/game/image/c405f953-f7ca-4da5-8309-dcba4fc44e7d.png"
                  alt=""
                />
              </div>
          ...
          <div class="sc-gfqkcP epfPPG bot-view mine">
            <a class="sc-hKTqa gJEGaM game-item-wrap" href="/mines">
              <div class="lazy-img img">
                <img
                  src="https://img2.nanogames.io/game/image/48c4ac4d-8e93-4ad4-af48-695fa8f5397e.png"
                  alt=""
                />
              </div>
              <div class="hover-mask">
          ...
          <div class="sc-gfqkcP epfPPG bot-view game-CrashTrenball">
            <a class="sc-hKTqa gJEGaM game-item-wrap" href="/crash/trenball">
              <div class="lazy-img img">
                <img
                  src="https://img2.nanogames.io/game/image/4398e0b7-7da4-4d42-b67d-33d5f2785fc6.png"
                  alt=""
                />
              </div>
              <div class="hover-mask">
              ...
              <div class="sc-hmvnCu emIWso">
                ...
                <tbody>
                  <tr>
                    <td class="game-name">
                      <img
                        src="https://static.nanogames.io/assets/Limbo.011b8b65.png"
                        class="game-icon"
                        alt=""
                      />
                    ...
                    <td>
                      <a class="sc-jUosCB iTDswZ user-info" href="/">
                        <div class="name">Goombas™</div>
                      </a>
                    </td>
                    <td>0.00x</td>
                    <td class="lose">
                      <div class="sc-Galmp erPQzq coin notranslate has-sign">
                        ...
                        <div class="amount">
                          <span class="amount-str"
                            >0.192884<span class="suffix">00</span></span
                          >
                        </div>
                      </div>
                    </td>
