...
<div class="sc-bkkeKt kBjSXI">
    <div class="dialog "style="opacity: 1; width: 464px; height: 631px; margin-top: -315.5px; margin-left: -232px; transform: scale(1) translateZ(0px);">
        ...
        <button on:click={()=> handleCandle()}  class="sc-ieecCq fLASqZ close-icon dialog-close">
        ...
        <div class="dialog-body default-style " style="z-index: 2; transform: none;">
            <div class="sc-dkPtRN jScFby scroll-view sc-cBIieI sPGks dialog-box">
                <div class="hotkey-list">
                    <div class="hotkey-item">
                        <div class="hotkey-txt">Half bet amount</div>
                        <div class="hotkey-key">A</div></div>
                    <div class="hotkey-item">
                ...
                <div  class="hotkey-enabled">
                    <button  on:click={handleHotkeyEnable} class={`hotkey-select ${isEnable ? "active" : ""} `}></button>
...
.sPGks .hotkey-item .hotkey-key::after {
    content: "";
    left: 0px;
    top: 0px;
    bottom: 0px;
...
.sPGks .hotkey-enabled .hotkey-select {
    width: 1rem;
    height: 1rem;
    border-radius: 50%;
    margin-right: 0.5rem;
...
.sPGks .hotkey-enabled .hotkey-select.active::after {
    content: "";
    position: absolute;
    width: 0.625rem;
    height: 0.625rem;
