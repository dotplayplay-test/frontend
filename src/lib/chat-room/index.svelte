                    ...
                    <div class="title">
                      <div class="name">
                        ...
                        <div class="more_container">
                          ...
                          >
                            <Icon size="16" src={BsCashCoin} />
                          </button>
                          <button
                            on:click={() => {
                              goto(`/user/profile/${chat.user_id}`);
                            }}
                          >
                            <Icon size="16" src={FiAtSign} />
                          </button>
                        </div>
                      </div>
                    </div>
...
<style>
  ...
  .VfNib:hover .title .more_container {
