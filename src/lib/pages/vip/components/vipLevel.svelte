<script>
  ...
  const milestones = [
    1, 4, 8, 14, 22, 30, 38, 46, 54, 62, 70, 78, 86, 94, 102, 110,
  ];
  $: isHovering = {};
  ...
  $: {
    ...
    milestoneIndex = milestones.findIndex(
      (m, i) => m >= vipLevel || milestones[i + 1] > vipLevel
    );
    const upperLimitIndex =
      (milestones[milestoneIndex] !== vipLevel &&
        milestones.findIndex((m) => vipLevel < m)) ||
      milestoneIndex;
    const percentageOffset =
      milestoneIndex !== upperLimitIndex
        ? (((vipLevel - milestones[milestoneIndex]) /
            (milestones[upperLimitIndex] - milestones[milestoneIndex])) *
            100) /
          milestones.length
        : 0;
    progressPercent = Math.max(
      0,
      Math.floor(
        (milestoneIndex / (milestones.length - 1)) * 100 + percentageOffset
      ) - 3.2
    ); // - 3.2 offset centering
  }
  ...
  onMount(() => {
    ...
    const left =
      Math.floor(
        (milestones.length - scrollContainer.offsetWidth / itemWidth) *
          itemWidth
      ) *
      ((((itemWidth * milestoneIndex) / (itemWidth * (milestones.length - 1))) *
        100) /
        100);
    scrollContainer.scrollTo({
      left,
...
<div class="sc-bkkeKt kBjSXI" style="opacity: 1;">
  ...
  >
    ...
    >
      <div class="sc-dkPtRN jScFby scroll-view sc-cBIieI gZgzWG vip-level">
        ...
        <div class="sc-wkwDy faOyUB vip-bonus">
          <div class="vip-bonus-title">
            <img
              ...
              alt=""
            /><span class="vip-bonus-subtit">Whole VIP Bonus</span><img
              class="img-star"
              src="https://static.nanogames.io/assets/star.34db71a0.png"
              alt=""
            />
          ...
          >
            <div class="bp-scroll">
              <div class="sc-eoHXOn inWmVI vip-bonus-list">
                <div bind:this={bonusItems} class="vip-bonus-wrap">
                  {#each items as item (item)}
                    <div
                      on:pointerleave={() => (isHovering[item] = false)}
                      on:pointerenter={() => (isHovering[item] = true)}
                      class="vip-bonus-item tr_{itemNumbers[
                        item
                      ]} tr_near {isHovering[item] ? 'tr_active' : ''}"
                    >
                      <div class="hover-ani-tr">
                        <div
                          class={itemNumbers[item] === 5
                        ...
                        {#if !isHovering[item]}
                          {#if !item || itemNumbers[item] === 5}
                            <div
                              class="light-img {itemNumbers[item] === 5
                                ? 'light-svip'
                                : ''}"
                            >
                              <img
                        ...
                        {:else}
                          ...
                          {:else if itemNumbers[item] === 4}
                            ...
                            />
                          {:else}
                            <div class="light-img light-svip ani-svip">
                              <img
              ...
              <div class="sc-fSDTwv kTcTWf vip-bonus-progress pr-bronze">
                <div class="tri-wrap">
                  <li
                    class="tri-top"
                ...
                <div class="pr-bar">
                  ...
                  <div class="pr-progress" style="width: {progressPercent}%;">
                    <div
                      class="dot-wrap"
                      style="left: {progressPercent}%; transform: translateX(-18px);"
                    >
                      <div class="dot-near">
          ...
          <div class="vip-bonus-cont">
            DOTPLAYPLAY VIP Level System sets 14 VIP Secret Treasures. Although
            there are rewards for every VIP level, the rewards for 14 secret
            treasures are exceptionally generous. Rewards increase as the VIP
            card level climbs. Speed up!
          </div>
        </div>
        <VipSystem />
      </div>
...
<style>
  ...
  .gZgzWG .vip-level-banner .wager-wrap .ribbon {
    ...
    font-weight: bold;
    margin-top: 0.625rem;
    background: url(https://static.nanogames.io/assets/ribbon.f9e96837.png) 0%
      0% / 100% no-repeat;
  }
  ...
  .inWmVI .vip-bonus-wrap .vip-bonus-item.tr_active.tr_2 .hover-ani-tr {
    background-image: linear-gradient(rgb(148, 148, 184), rgb(139, 153, 162));
  }
