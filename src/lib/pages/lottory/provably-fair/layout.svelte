  ...
  const handleVerificationClick = () => {
    ...
    window.open(
      `${origin}/verify/lottery?${
        gameSeeds.server_seed ? `s=${gameSeeds.server_seed}` : ""
      }${gameSeeds.client_seed_hash ? `&c=${gameSeeds.client_seed_hash}` : ""}`,
      "_blank"
    );
  };
</script>
...
<div class="sc-bkkeKt kBjSXI" style="opacity: 1;">
  <div
    class="dialog"
    style="opacity: 1; width: 464px; margin-top: -280px; margin-left: -232px; transform: scale(1) translateZ(0px);"
  >
        ...
        >
          <div class="sc-dkPtRN jScFby scroll-view sc-kTqLtj gKwlPS dialog-box">
            <div class="tips">
              ...
              the results using <button on:click={handleVerificationClick}
                >online verifier</button
              > and following data. The whole data including the file with purchased
              tickets is available only when ticket sales stopped.
            </div>
            ...
            <div class="sc-ezbkAF kDuLvp input">
              ...
              <div class="input-control">
                <input
                  type="text"
                  readonly
                  value={gameSeeds.server_seed || "Reveal after draw"}
                />
              </div>
            </div>
            <div class="sc-ezbkAF kDuLvp input">
            ...
            >
              ...
              <div on:click={handleVerificationClick} class="button-inner">
                Verify
              </div>
            </button>
          </div>
...
<style>
  ...
  .dialog {
    max-height: 720px; height: calc(100vh - 5%);
    position: absolute;
    display: flex;
