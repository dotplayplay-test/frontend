...
.bonus__item.bonus-rain .item-wrap {
    background: url(https://static.nanogames.io/assets/rain.21324c91.png) 96% center / auto 80% no-repeat, linear-gradient(160deg, rgb(100, 113, 133) -121%, rgb(30, 32, 36) 51%);
}
.kVGwZM .item-wrap {
    height: 100%;
    min-height: 16rem;
