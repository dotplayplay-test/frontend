            ...
            <div class="sc-iJCbQK liaPil">
                <div class="dots-wrap">
                    <div class="dots">
                        ...
                        <div class="sc-fSDTwv itetCR dot type-1"></div>
                        <div class="sc-fSDTwv itetCR dot type-2"></div>
                        <div class="sc-fSDTwv itetCR dot type-2"></div>
                        <div class="sc-fSDTwv itetCR dot type-2"></div>
                        <div class="sc-fSDTwv itetCR dot type-2"></div>
                        <div class="sc-fSDTwv itetCR dot type-1"></div>
                        ...
                        <div class="sc-fSDTwv itetCR dot type-2"></div>
                        <div class="sc-fSDTwv itetCR dot type-2"></div>
                        <div class="sc-fSDTwv itetCR dot type-0"></div>
                ...
                <button class="sc-bXRjm kFDPAv">
                    <svg xmlns:xlink="http://www.w3.org/1999/xlink" class="sc-gsDKAQ hxODWG icon help-ico"><use xlink:href="#icon_Help"></use>
                    </svg>
                    <div>Understanding Trend Chart</div>
                </button>
            </div>
