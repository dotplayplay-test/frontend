    ...
    <div class="footer-wrap">
            ...
            <div class="currency-list">
                <div class="currency-item">
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M.36 9.098C1.96 2.67 8.472-1.244 14.901.36c6.43 1.603 10.342 8.115 8.739 14.544-1.603 6.428-8.115 10.34-14.545 8.738C2.669 22.038-1.244 15.527.359 9.098zM11.917 4l-.602 2.39a51.48 51.48 0 01-.937-.218l.002-.008-2.025-.5-.39 1.554s1.089.247 1.066.263c.594.147.702.537.684.846l-.685 2.725c.041.01.094.025.153.048l-.155-.038-.96 3.816c-.073.18-.258.448-.673.346.015.021-1.067-.264-1.067-.264L5.6 16.626l1.91.472c.356.088.704.181 1.047.268l-.608 2.419 1.467.362.601-2.393c.4.108.79.208 1.17.302l-.6 2.381 1.469.363.607-2.414c2.503.47 4.386.28 5.178-1.965.638-1.807-.032-2.85-1.349-3.53.96-.22 1.682-.845 1.875-2.137.266-1.765-1.09-2.714-2.943-3.347l.601-2.392-1.468-.363-.585 2.329a60.163 60.163 0 00-1.176-.275l.59-2.343L11.917 4zm-.784 8.806c1.033.256 4.349.763 3.856 2.721-.471 1.878-3.66.863-4.694.608l.838-3.329zm1.142-4.543c.86.213 3.634.61 3.186 2.392-.43 1.708-3.084.84-3.945.627l.759-3.019z"></path>
                    </svg>
                </div>
                <div class="currency-item">
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0zM7.2 13.121l5.198 7.504 5.058-7.432-5.096 3.029-5.16-3.1zM12.223 3.2l-4.918 8.874v.001l3.091 1.931 1.932 1.208 3.418-2.021 1.71-1.01-.001-.001L12.223 3.2z"></path>
                    </svg>
                </div>
                <div class="currency-item">
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 0c6.628 0 12 5.372 12 12 0 6.627-5.372 12-12 12-6.627 0-12-5.373-12-12C0 5.372 5.373 0 12 0zm.686 5.6H7.96v5.689H6.4v1.363h1.56V18.4h5.08c.745-.019 5.36-.39 5.36-6.845 0-5.642-5.17-5.939-5.714-5.954zm3.274 6.12c0 4.139-2.548 4.305-2.874 4.31l-2.686-.001v-3.377h2.63v-1.363H10.4V7.97h2.512c.26.008 3.048.174 3.048 3.749z"></path>
                    </svg>
                </div>
                <div class="currency-item">
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 0c6.628 0 12 5.372 12 12s-5.372 12-12 12C5.373 24 0 18.628 0 12S5.373 0 12 0zm5.6 6.4H6.4v2.591h4.248l-.001 1.437c-3.33.14-5.847.785-5.847 1.56 0 .772 2.5 1.415 5.812 1.558V19.2h2.724v-5.652c3.338-.138 5.864-.784 5.864-1.56 0-.775-2.517-1.42-5.847-1.56l-.001-1.437H17.6V6.4zm.812 5.382c0 .68-2.87 1.232-6.412 1.232-3.541 0-6.412-.552-6.412-1.232 0-.59 2.167-1.084 5.059-1.204l.001 2.222h2.704l.001-2.222c2.892.12 5.059.614 5.059 1.204z"></path>
                    </svg>
                </div>
                <div class="currency-item">
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.95 12.22l-1.1 3.5h5.85c.16-.01.3.1.3.26v.1l-.5 1.65a.38.38 0 01-.39.27H7.18l1.5-4.84-1.68.48.38-1.1 1.68-.49 2.1-6.78c.05-.17.2-.27.38-.27h2.26c.16 0 .3.12.3.27v.1l-1.77 5.72 1.68-.48-.36 1.15-1.7.46zM12 0a12 12 0 10.07 0H12z"></path>
                    </svg>
                </div>
            </div>
        </div>
        <div class="cert-box">
            <div class="footer__cert">
                <a href="/">
                    <svg width="90" height="32" xmlns="http://www.w3.org/2000/svg"><g>
